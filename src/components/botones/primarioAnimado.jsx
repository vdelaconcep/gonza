...
const PrimarioAnimado = ({ texto, accion }) => {
    ...
    return (
        <div className="relative w-8 h-8">
            ...
            <button
                className="bg-black text-black whitespace-nowrap font-mono font-semibold px-5 py-2 rounded-full border-2 border-black absolute -bottom-1 left-1/2 -translate-x-1/2 z-10"
                onClick={accion}>
                {texto ? texto : 'Primario animado'}
            </button>
        </div>
